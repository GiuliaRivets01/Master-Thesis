...
class TrainingInitializer():
    ...
    def main(self):
        training_args = TrainingArguments(
            ...
            per_device_train_batch_size=self.configs['training']['batch_size'],
            per_device_eval_batch_size=self.configs['training']['batch_size'],
            num_train_epochs=self.configs['training']['epochs'],
            weight_decay=self.configs['training']['weight_decay'],
